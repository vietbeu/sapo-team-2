    ...
    validateName = (text) => {
        ...
        if (result !== null) {
            ...
            return { isNameValid: false,
                     errorNameMessage: 'Tên không hợp lệ'};
        }
    }
    validationName = (e) => {
        const {isNameValid,errorNameMessage} = this.validateName(this.state.name);
        this.setState({
            ...
            <React.Fragment>
                ...
                <div className='register-form'>
                    <form onSubmit={this.handleSubmit}>
                        <div>
                            <div className='input'> 
                                <input type='text' placeholder='Họ và tên' required onChange={this.channgeName} 
                                autoComplete='off' onKeyUp={this.validationName}/>
                                <div className='error'>
                                    <FormError isHidden={this.state.isNameValid} errorMessage={this.state.errorNameMessage} />
                                </div>
                            </div>
                            <div className='input'>
                                <input type='text' placeholder='Số điện thoại' autoComplete='off' required
                                onChange={this.changePhone} onKeyUp={this.validationPhone}/>
                                <div className='error'>
                            ...
                            <div className='input'>
                                ...
                                onChange={this.changeEmail} onKeyUp={this.validationEmail}/>
                                <div className='error'>
                            ...
                            <div className='input'>
                                ...
                                onChange={this.changePass} onKeyUp={this.validationPass}/>
                                <div className='error'>
                            ...
                            <div className='input'>
                                ...
                                onChange={this.changeConfirmPass} onKeyUp={this.validationConfirmPass}/>
                                <div className='error'>
